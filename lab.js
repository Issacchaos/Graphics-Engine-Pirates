...
function Fur(furprog){
    ...
    furprog.setUniform("fogColor",[0.4,0.7,0.9,0.2]);
...
function LensFlare(){
	...
	fboFlare2.unbind();	
	gl.clearColor(0.4,0.7,0.9,0.2);				//reset the clear color to original color
	//****************************************************************************************	
...
function Shooting(prog){
    ...
    prog.setUniform("fogColor",[0.4,0.7,0.9,0.2]);
